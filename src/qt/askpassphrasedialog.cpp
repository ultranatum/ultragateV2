...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            ULTRAGATEGUI* window = static_cast<ULTRAGATEGUI*>(parentWidget());
...
{
    ULTRAGATEGUI* gui = static_cast<ULTRAGATEGUI*>(parentWidget());
...
{
    hide();
    static_cast<ULTRAGATEGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
