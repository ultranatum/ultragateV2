...
#include "qt/ultragate/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/ultragate/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(ULTRAGATEGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableULG,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableULG,
    ...
    connect(ui->pushButton_UnspendableULG, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableULG);});
    ...
    if (parent)
        connect(parent, &ULTRAGATEGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
