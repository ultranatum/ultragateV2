...
#include "qt/ultragate/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/ultragate/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(ULTRAGATEGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to ULTRAGATEGUI::handleRestart()
