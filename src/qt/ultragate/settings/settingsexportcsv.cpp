...
#include "qt/ultragate/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(ULTRAGATEGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("ULTRAGATE_tx_csv_export(*.csv)") : tr("ULTRAGATE_addresses_csv_export(*.csv)"),
                                        nullptr);
