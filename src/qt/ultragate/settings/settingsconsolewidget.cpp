...
#include "qt/ultragate/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/ultragate/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(ULTRAGATEGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    messageInternal(CMD_REPLY, (tr("Welcome to the Ultragate RPC console.") + "<br>" +
