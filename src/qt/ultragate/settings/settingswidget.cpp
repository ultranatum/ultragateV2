...
#include "qt/ultragate/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(ULTRAGATEGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &ULTRAGATEGUI::openFAQ);
