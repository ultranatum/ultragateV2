...
#include "qt/ultragate/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(ULTRAGATEGUI* _window, QWidget *parent) :
