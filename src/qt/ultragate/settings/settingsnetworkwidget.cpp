...
#include "qt/ultragate/settings/settingsnetworkwidget.h"
#include "qt/ultragate/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/ultragate/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(ULTRAGATEGUI* _window, QWidget *parent) :
