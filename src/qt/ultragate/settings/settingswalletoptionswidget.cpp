...
#include "qt/ultragate/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/ultragate/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(ULTRAGATEGUI* _window, QWidget *parent) :
