...
#include <QWidget>
#include <QString>
#include "qt/ultragate/prunnable.h"
...
class PWidget : public QWidget, public Runnable, public Translator
{
    Q_OBJECT
public:
    explicit PWidget(ULTRAGATEGUI* _window = nullptr, QWidget *parent = nullptr);
    explicit PWidget(PWidget *parent = nullptr);

    void setClientModel(ClientModel* model);
    void setWalletModel(WalletModel* model);

    ULTRAGATEGUI* getWindow() { return this->window; }
