...
#ifndef ULTRAGATE_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define ULTRAGATE_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //ULTRAGATE_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
