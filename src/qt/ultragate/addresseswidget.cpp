...
#include "qt/ultragate/forms/ui_addresseswidget.h"
#include "qt/ultragate/addresslabelrow.h"
#include "qt/ultragate/addnewaddressdialog.h"
#include "qt/ultragate/tooltipmenu.h"
...
AddressesWidget::AddressesWidget(ULTRAGATEGUI* parent) :
    PWidget(parent),
...
void AddressesWidget::onStoreContactClicked()
{
    if (walletModel) {
        ...
        CTxDestination ulgAdd = DecodeDestination(address.toUtf8().constData());
        ...
        if (walletModel->updateAddressBookLabels(
            ulgAdd, label.toUtf8().constData(),AddressBook::AddressBookPurpose::SEND
        )) {
