...
#include "qt/ultragate/furabstractlistitemdelegate.h"
#include "qt/ultragate/furlistrow.h"
#include "transactiontablemodel.h"
#include "qt/ultragate/txviewholder.h"
...
#include "config/ultragate-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    explicit DashboardWidget(ULTRAGATEGUI* _window);
    ~DashboardWidget();
