...
#include "qt/ultragate/sendcustomfeedialog.h"
#include "qt/ultragate/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(ULTRAGATEGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &ULTRAGATEGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
