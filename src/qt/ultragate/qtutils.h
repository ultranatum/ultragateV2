...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, ULTRAGATEGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, ULTRAGATEGUI* gui, double posX = 3);
