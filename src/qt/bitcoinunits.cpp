...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(ULG);
    unitlist.append(mULG);
    unitlist.append(uULG);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case ULG:
        return QString("ultragate");
    case mULG:
        return QString("multragate");
    case uULG:
        return QString::fromUtf8("uultragate");
    default:
        return QString("???");
    }
}

QString BitcoinUnits::name(int unit, bool isZulg)
{
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZULG)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, isZULG);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZULG)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, isZULG));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}
