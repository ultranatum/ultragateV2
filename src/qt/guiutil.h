...
/** Utility functions used by the Ultragate Qt UI.
 */
namespace GUIUtil
{
...
// Render Ultragate addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZulg = false);
...
// Parse "ultragate:" URI into recipient object, return true on successful parsing
