...
#ifndef ULTRAGATE_STAKEINPUT_H
#define ULTRAGATE_STAKEINPUT_H
...
public:
    ...
    bool IsZULG() const override { return false; }
    bool ContextCheck(int nHeight, uint32_t nTime) override;
};


#endif //ULTRAGATE_STAKEINPUT_H
