...
#ifndef ULTRAGATE_ZULGTRACKER_H
#define ULTRAGATE_ZULGTRACKER_H
...
public:
    CzULGTracker(CWallet* parent);
    ~CzULGTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzULGWallet* zULGWallet = NULL);
