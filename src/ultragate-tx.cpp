...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Ultragate Core ultragate-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ultragate-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ultragate transaction") + "\n" +
                               "  ultragate-tx [options] -create [commands]   " + _("Create hex-encoded ultragate transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ultragate transaction
