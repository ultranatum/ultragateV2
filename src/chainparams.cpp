...
// Copyright (c) 2020-2022 The Ultragate Core Developers
...
/**
 *python ~/GenesisH0new/genesis.py -a quark-hash -z "Crypto Users Are Still Scared to Pay With Bitcoin in 2019 FIO Protocol Aims to Fix That" -t 1661761473 -p 04856094205FE697B9843BE05EAD9F2D4D8320192DC507FD7811BB857BABDFD58A428912B66F567DEC8042CF61229B69251690E648B55BDE0301EE17B672255AC5 -v 0
 ...
 *bits: 0x1e0ffff0
 *nonce: 2505349
 *genesis hash: 000005d00e2076ace681b9e05a491475d47b64015da1f6f80dd7910cde0133ce
 */
static CBlock CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    const CScript genesisOutputScript = CScript() << ParseHex("04856094205FE697B9843BE05EAD9F2D4D8320192DC507FD7811BB857BABDFD58A428912B66F567DEC8042CF61229B69251690E648B55BDE0301EE17B672255AC5") << OP_CHECKSIG;
...
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1662033600, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        genesis = CreateGenesisBlock(1661761473, 2505349, 0x1e0ffff0, 1, 0 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x000005d00e2076ace681b9e05a491475d47b64015da1f6f80dd7910cde0133ce"));
        assert(genesis.hashMerkleRoot == uint256S("0x2040b0abc8d4a76241d511d9a913f363770304d18617a599e839869aeef7061b"));

        consensus.fPowAllowMinDifficultyBlocks = false;
        consensus.fSkipProofOfWorkCheck = true;
        consensus.powLimit   = ~UINT256_ZERO >> 20;   // Ultragate starting difficulty is 1 / 2^12
        ...
        consensus.nStakeMinDepth = 60; //50
        consensus.nTargetTimespan = 40 * 60;
        consensus.nTargetTimespanV2 = 30 * 60;
        consensus.nTargetSpacing = 5 * 30;        // 1 * 60    1 minute
        consensus.nTimeSlotLength = 15;

        // spork keys
        consensus.strSporkPubKey = "04DB894EA030F7333393A7DE5CAEFD2FB8E53D2A1F0851267D78F666ADAC85E781CBC464B674986811071F5524FD5F8C5999300682FBCDBFAED9B1A0A8137CEA19";
        ...
        consensus.ZC_TimeStart = 1808214600;        // Tue Apr 20 2027 09:50:00 GMT+0000
        ...
        consensus.vUpgrades[Consensus::UPGRADE_POS_V2].nActivationHeight        = 1301;
        consensus.vUpgrades[Consensus::UPGRADE_ZC].nActivationHeight            = 
                Consensus::NetworkUpgrade::NO_ACTIVATION_HEIGHT;
        consensus.vUpgrades[Consensus::UPGRADE_ZC_V2].nActivationHeight         = 
                Consensus::NetworkUpgrade::NO_ACTIVATION_HEIGHT;
        consensus.vUpgrades[Consensus::UPGRADE_BIP65].nActivationHeight         = 1401;
        consensus.vUpgrades[Consensus::UPGRADE_ZC_PUBLIC].nActivationHeight     = 
                Consensus::NetworkUpgrade::NO_ACTIVATION_HEIGHT;
        consensus.vUpgrades[Consensus::UPGRADE_STAKE_MODIFIER_V2].nActivationHeight          = 1501;
        consensus.vUpgrades[Consensus::UPGRADE_TIME_PROTOCOL_V2].nActivationHeight          = 2000001;
        ...
        consensus.vUpgrades[Consensus::UPGRADE_ZC_PUBLIC].hashActivationBlock =
                uint256S("0x0");
        consensus.vUpgrades[Consensus::UPGRADE_STAKE_MODIFIER_V2].hashActivationBlock =
                uint256S("0x0");
        consensus.vUpgrades[Consensus::UPGRADE_TIME_PROTOCOL_V2].hashActivationBlock =
                uint256S("0x0");
...
public:
    CTestNetParams()
    {
        ...
        genesis = CreateGenesisBlock(1661761474, 228355, 0x1e0ffff0, 1, 0 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000f3d13c73ed7508dc5b3863f24b176efad69ad46b5f3d9b6bca72f986e0d"));
        assert(genesis.hashMerkleRoot == uint256S("0x2040b0abc8d4a76241d511d9a913f363770304d18617a599e839869aeef7061b"));
        ...
        consensus.nFutureTimeDriftPoW = 7200;
        consensus.nFutureTimeDriftPoS = 180;
        consensus.nMaxMoneyOut = 32000000 * COIN;
        ...
        // spork keys
        consensus.strSporkPubKey = "0455BA14D5120EB6AD9F5A878EC715385E127A6FDBC29E47CC75ADDCB4D1D5D801E59487C6F1C99357C186B13D331D0EC0E7D2981ECA0559FA7ED44DB304ED355A";
        ...
        consensus.vUpgrades[Consensus::UPGRADE_TIME_PROTOCOL_V2].nActivationHeight          = 201;
        consensus.vUpgrades[Consensus::UPGRADE_V5_DUMMY].nActivationHeight =
                Consensus::NetworkUpgrade::NO_ACTIVATION_HEIGHT;
...
public:
    CRegTestParams()
    {
        ...
        genesis = CreateGenesisBlock(1661761475, 2116033, 0x1e0ffff0, 1, 0 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0000081eed90435636e742f0372ddd89d4615504a64c74dd742587a4e44fe4e3"));
        assert(genesis.hashMerkleRoot == uint256S("0x2040b0abc8d4a76241d511d9a913f363770304d18617a599e839869aeef7061b"));
