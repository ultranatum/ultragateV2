Contributing to Ultragate Core
============================

The Ultragate Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/ultranatum/ultragate/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Ultragate Core project, and is not to be
confused with overall Ultragate Network Protocol consensus changes.

Whether a pull request is merged into Ultragate Core rests with the project merge
...
Patches that change Ultragate consensus rules are considerably more involved than
...
Where a patchset proposes to change the Ultragate consensus, it must have been
...
The project leader is the release manager for each Ultragate Core release.
