...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/ultragate-cli.cpp \
           src/ultragate-tx.cpp \
           src/ultragate.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/ultragate.qrc src/qt/ultragate_locale.qrc

TRANSLATIONS += src/qt/locale/ultragate_bg.ts \
                src/qt/locale/ultragate_de.ts \
                src/qt/locale/ultragate_en.ts \
                src/qt/locale/ultragate_es.ts \
                src/qt/locale/ultragate_fi.ts \
                src/qt/locale/ultragate_fr.ts \
                src/qt/locale/ultragate_it.ts \
                src/qt/locale/ultragate_ja.ts \
                src/qt/locale/ultragate_pl.ts \
                src/qt/locale/ultragate_pt.ts \
                src/qt/locale/ultragate_ru.ts \
                src/qt/locale/ultragate_sk.ts \
                src/qt/locale/ultragate_sv.ts \
                src/qt/locale/ultragate_vi.ts \
                src/qt/locale/ultragate_zh_CN.ts \
                src/qt/locale/ultragate_zh_TW.ts
